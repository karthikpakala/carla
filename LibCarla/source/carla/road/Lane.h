...
namespace road {
  ...
  public:
    ...
    // Use the new lane types from MapDataTypes.hpp
    using LaneType = ts::LaneType;
    using RoadType = ts::RoadType;
    using LaneBoundaryType = ts::LaneBoundaryType;
    using LaneBoundaryColor = ts::LaneBoundaryColor;
    using LaneBlockageState = ts::LaneBlockageState;
    using LaneDirection = ts::LaneDirection;
    using LaneRightOfWay = ts::LaneRightOfWay;
    using SurfacePolygonType = ts::SurfacePolygonType;
  ...
  private:
    ...
    LaneType _type = LaneType::NotSet;
